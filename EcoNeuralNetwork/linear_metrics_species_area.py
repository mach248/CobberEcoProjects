"""
linear_metrics_species_area.py
------------------------------
Computes MAE, MSE, and R-squared for the linear regression baseline
on the original 15 species-area data points.

These numbers are the baseline to beat with a neural network.
...
# -- Fit and predict on the original 15 points --------------------------------
...
print("Linear regression performance (original 15 data points):")
print("-" * 55)
